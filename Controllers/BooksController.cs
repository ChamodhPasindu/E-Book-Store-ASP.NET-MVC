...
namespace EBookStore.Controllers
{
	public class BooksController : Controller
	{
		...
		public IActionResult AddOrEdit(Book book, IFormFile ImageFile)
		{
			...
			{
				TempData["ErrorMessage"] = $"An error occurred while add or edit book request. Please try again later: {ex.Message}";
				return View("Error");
			}
		}
		...
		public async Task<IActionResult> Delete(int id)
		{
			...
			{
				TempData["ErrorMessage"] = $"An error occurred while deleting book. Please try again later: {ex.Message}";
				return View("Error");
			}
		}
